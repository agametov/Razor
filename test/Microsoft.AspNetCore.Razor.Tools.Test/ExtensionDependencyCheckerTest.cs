...
{
    public class ExtensionDependencyCheckerTest
    {
        [Fact]
        public void Check_WithMissingReference_ReturnsFalse()
        {
            using (TempDirectory.Create())
            {
        ...
        public void AssemblyLoadException()
        {
            ...
            var result = ExtensionD.Check(directory.Path, analyzerReferences, new FaultyAssemblyLoader());
